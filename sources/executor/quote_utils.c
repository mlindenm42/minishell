...
/*   Updated: 2023/10/17 05:17:34 by mrubina          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// '"$USER"'
void	exp_quotes(char **word, char *exit_stat, char *envp[], t_errdata *err)
{
	char	*tmp;
...
int	replace_q(char **word, char *next, char *exit_stat, t_errdata *err)
{
	...
	exp_quotes(&qpart, exit_stat, err->envp, err);//malloc
